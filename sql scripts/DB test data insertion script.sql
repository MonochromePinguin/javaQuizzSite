...
INSERT INTO `quizzes` VALUES (1,'MCQ Quizz #1, theme #3','quizz-1-theme-3',3,1,1,0,NULL),(2,'MCQ Quizz #2, theme #3 (10 random questions)','quizz-2-theme-3-random',3,2,1,1,10),(3,'free-text Quizz #3, theme #3, not random','free-text-quizz-3-theme-3',3,2,0,0,NULL),(4,'TEST – quizz with no question','test-quizz-no-question-inside',4,1,0,0,NULL),(5,'free-text Quizz #5, theme #4, random','quizz-5',4,1,0,1,5),(6,'BASH Quizz','BASH-Quizz',1,1,0,0,NULL),(7,'small BASH Quizz (5 random questions)','small-bash-quizz-5',1,1,1,1,5),(8,'small BASH Quizz (10 random questions, free-text)','small-bash-quizz-10',1,2,0,1,10),(9,'BASH advanced quizz (free-text)','bash-advanced-quizz',1,2,0,0,NULL),(10,'linux command-line tools','linux-tools',2,3,1,0,NULL),(11,'linux command-line tools (8 random questions)','linux-tools-random-8',2,3,0,1,8),(12,'BASH quizz #2 (MCQ)','bash-quizz-2',1,3,1,0,NULL),(13,'POSIX utilities (MCQ)','posix-utilities',2,1,1,0,NULL),(14,'TEST – Quizz with bad slug, should send to a 404 err page','<test?bad=quizz+slug+>',3,1,1,0,NULL),(15,'TEST - quizz with a question without answer','test-quizz-with-a-question-without-answer',1,2,1,0,NULL),(16,'TEST - quizz with 4 MCQ questions, theme 1','test-4-questions-mcq',1,1,1,0,NULL),(17,'TEST - quizz with 4 random MCQ questions, theme 1','test-4-random-questions-mcq',1,1,1,1,4);
